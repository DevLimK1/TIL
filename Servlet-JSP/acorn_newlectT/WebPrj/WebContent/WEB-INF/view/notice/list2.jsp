<%@page import="com.newlecture.web.service.NoticeService2"%>
...
<%
	NoticeService2 service =new NoticeService2();
	NoticeView[] list =service.getNoticeList();
%>
							...
							%>
							 <tr <%=style%>>
								...
								<td class="title indent text-align-left"><a
									href="detail.html"><%=list[i].getTitle() %></a></td>
								<td><%=list[i].getWriterId()%></td>
