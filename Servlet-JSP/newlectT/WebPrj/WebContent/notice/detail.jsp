				...
				<div class="margin-top first">
						...
						<table class="table">
							<tbody>
								<tr>
									<th>제목</th>
									<td class="text-align-left text-indent text-strong text-orange" colspan="3"><%=((Notice)request.getAttribute("n")).getTitle()%></td>
								</tr>
								<tr>
									<th>작성일</th>
									<td class="text-align-left text-indent" colspan="3"><%=((Notice)request.getAttribute("n")).getRegdate() %>	</td>
								</tr>
								<tr>
									<th>작성자</th>
									<td><%= ((Notice)request.getAttribute("n")).getWriterId() %></td>
									<th>조회수</th>
									<td><%=((Notice)request.getAttribute("n")).getHit() %></td>
								</tr>
								<tr>
									<th>첨부파일</th>
									<td colspan="3"></td>
								...
								<tr class="content">
									<td colspan="4"><%=((Notice)request.getAttribute("n")).getContent() %></td>
								</tr>
							</tbody>
						</table>
					</div>
